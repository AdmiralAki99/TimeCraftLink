...
//        contentView.addSubview(albumType)
    ...
    func generateViewCell(with viewModel: NewReleasesPreview){
        albumName.text = viewModel.name
        artistName.text = viewModel.artistName
        albumType.text = viewModel.album_type
        albumArtwork.sd_setImage(with: viewModel.image,completed: nil)
    }
    
//    func generateCustomCell(with cell: NewReleasesPreview){
//        albumName.text = cell.name
