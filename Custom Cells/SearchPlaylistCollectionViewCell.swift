//
//  SearchPlaylistCollectionViewCell.swift
//  TimeCraft
//
...
class SearchPlaylistCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "SearchPlaylistCollectionViewCell"
