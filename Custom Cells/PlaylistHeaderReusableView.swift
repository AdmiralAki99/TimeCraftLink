...
protocol PlaylistHeaderReusableViewDelegate : AnyObject {
    func playlistHeaderReusableViewPlayAllButton(_ header: PlaylistHeaderReusableView)
}

final class PlaylistHeaderReusableView: UICollectionReusableView {
    static let identifier = "PlaylistHeaderReusableView"
    
    weak var delegate: PlaylistHeaderReusableViewDelegate?
...
//        ownerImage.sd_setImage(with: playlistModel.authorArtwork,completed: nil)
    ...
    @objc private func didTapPlayButton(){
        delegate?.playlistHeaderReusableViewPlayAllButton(self)
    }
